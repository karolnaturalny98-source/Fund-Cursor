  ...
  return (
    <div className="space-y-[clamp(1.5rem,2.3vw,2.1rem)]">
      <div className="space-y-[clamp(0.55rem,0.85vw,0.75rem)]">
        <h1 className="fluid-h2 font-semibold tracking-tight text-foreground">Dashboard Społeczności</h1>
      ...
      <Tabs defaultValue="overview" className="space-y-[clamp(1.25rem,1.9vw,1.7rem)]">
        <TabsList className="flex flex-wrap gap-[clamp(0.55rem,0.85vw,0.75rem)] bg-transparent p-0">
          ...
          >
            <div className="flex items-center gap-[clamp(0.4rem,0.6vw,0.5rem)]">
              <Users className="h-[clamp(1.05rem,0.4vw+0.95rem,1.2rem)] w-[clamp(1.05rem,0.4vw+0.95rem,1.2rem)]" />
              <span className="font-semibold">Influencerzy</span>
            </div>
          </TabsTrigger>
          <TabsTrigger
            value="history"
        ...
        <TabsContent value="influencers" className="space-y-[clamp(1.25rem,1.9vw,1.7rem)]">
