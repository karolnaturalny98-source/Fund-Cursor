  ...
  return (
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        {/* Filters */}
        <div className="flex flex-wrap gap-3 sm:gap-4 rounded-xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-3 sm:p-4 shadow-sm">
        ...
        <TabsContent value="all" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm p-4">
