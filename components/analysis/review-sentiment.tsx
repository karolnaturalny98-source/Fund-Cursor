    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {sentimentData.map((data) => (
          <Card key={data.companyId} className="rounded-2xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm">
            <CardHeader>
      ...
      {sentimentData.map((data) => (
        <Card key={`detail-${data.companyId}`} className="rounded-2xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm">
          <CardHeader>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {recentHighlights.map((company) => (
          <Card key={`recent-${company.companyId}`} className="rounded-2xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm">
            <CardHeader>
