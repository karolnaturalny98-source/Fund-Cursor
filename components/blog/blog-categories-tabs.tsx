...
export function BlogCategoriesTabs({
  ...
  return (
    <Tabs value={activeCategory} onValueChange={setActiveCategory} className="space-y-6">
      <TabsList className="flex w-full flex-wrap gap-2 rounded-lg border border-border/40 bg-[rgba(12,14,18,0.6)] !backdrop-blur-[36px] p-1 shadow-sm">
        <TabsTrigger
          value="all"
      ...
      <TabsContent value="all" className="space-y-6">
        {filteredPosts.length === 0 ? (
          <Alert className="rounded-lg border border-border/40 bg-[rgba(12,14,18,0.6)] !backdrop-blur-[36px] shadow-sm">
