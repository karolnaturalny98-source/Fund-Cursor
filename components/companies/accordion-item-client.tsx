    ...
    >
      ...
      <CardContent className="space-y-4 pt-0">
        {Object.keys(categorizedInstruments).length > 0 ? (
          ...
          <div className="rounded-lg border border-dashed border-border/60 bg-[rgba(12,14,18,0.6)] p-4 text-center text-xs text-muted-foreground">
    ...
    >
      ...
      {notes ? (
        <CardContent className="pt-0">
          <div className="rounded-lg border border-border/40 bg-[rgba(12,14,18,0.6)] p-2.5 text-xs text-muted-foreground">
            {notes}
          </div>
        </CardContent>
      ) : null}
