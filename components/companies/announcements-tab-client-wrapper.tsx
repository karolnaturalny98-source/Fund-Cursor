  ...
  return (
    <div className="space-y-10">
      ...
      <section
        ...
        className={cn(
          "group relative overflow-hidden rounded-3xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-6 shadow-sm transition-all hover:border-primary/50 hover:shadow-md",
