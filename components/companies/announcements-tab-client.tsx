...
export function AnnouncementCard({ item }: AnnouncementCardProps) {
  ...
  return (
    <Card className="group relative overflow-hidden rounded-xl border border-border/40 bg-background/60 backdrop-blur-[36px]! shadow-xs transition-all hover:border-primary/30 hover:shadow-xs">
