          ...
          <section className="space-y-6">
            <div className="relative">
              ...
              <Input
                ...
                className="w-full rounded-full border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] pl-9 shadow-sm"
                disabled={isPending}
              />
              {isPending && (
            ...
            {isPending && companies.length === 0 ? (
              <div className="grid gap-6">
                {Array.from({ length: 6 }).map((_, index) => (
                  <div
                    key={`skeleton-${index}`}
                    className="rounded-3xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-6 shadow-sm"
                  >
