...
export function CompanyHeroClient({ children }: CompanyHeroClientProps) {
  ...
  return (
    <header
      ref={heroAnim.ref}
      className={`relative grid gap-8 overflow-hidden rounded-3xl border border-border/60 bg-[rgba(10,12,15,0.72)]! backdrop-blur-[36px]! p-8 shadow-xs lg:grid-cols-[minmax(0,1fr)_340px] ${heroAnim.className}`}
    >
