...
export function CompanyInfoClient({ paymentMethods, platforms, instruments }: CompanyInfoClientProps) {
  ...
  return (
    <Card className="rounded-2xl border border-border/60 p-4 shadow-sm !bg-[rgba(10,12,15,0.72)]">
...
export function ChecklistItemClient({ item }: ChecklistItemClientProps) {
  ...
  return (
    <Card className="group rounded-lg border border-border/40 shadow-sm transition-all !bg-[rgba(12,14,18,0.6)] hover:border-border/60 hover:!bg-[rgba(14,16,20,0.48)]">
...
export function ResourceCardClient({ link, resourceType, index }: ResourceCardClientProps) {
  ...
  return (
    <Card className="group rounded-2xl border border-border/60 shadow-sm transition-all hover:border-primary/50 hover:shadow-md !bg-[rgba(10,12,15,0.72)]">
...
export function DefaultPlanCardClient({ planName, cashbackRate }: DefaultPlanCardClientProps) {
  return (
    <Card className="group relative overflow-hidden rounded-2xl border border-border/60 shadow-sm transition-all hover:border-primary/50 hover:shadow-md !bg-[rgba(10,12,15,0.72)]">
      <CardHeader className="space-y-3 pb-3">
    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {rows.map((row) => {
        ...
        return (
          <Card
            key={row.label}
            className="group rounded-2xl border border-border/60 shadow-sm transition-all hover:border-primary/50 hover:shadow-md !bg-[rgba(10,12,15,0.72)]"
          >
