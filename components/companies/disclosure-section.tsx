...
export function DisclosureSection({ companyName, tosUrl }: DisclosureSectionProps) {
  return (
    <Card
      className={cn(
        "group relative space-y-4 overflow-hidden rounded-3xl border border-border/60 p-6 text-sm shadow-xs transition-all hover:border-primary/50 hover:shadow-md text-muted-foreground bg-card/72 backdrop-blur-[36px]!"
      )}
    >
      <CardHeader className="p-0 pb-4">
        <CardTitle className="text-lg font-semibold text-foreground">Disclosure i etyka</CardTitle>
      </CardHeader>
