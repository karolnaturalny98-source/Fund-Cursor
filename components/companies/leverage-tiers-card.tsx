        ...
        {sortedTiers.map((tier, index) => {
          ...
          return (
            <Card
              ...
              className={`rounded-xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm transition-all hover:border-primary/50 hover:shadow-md ${
