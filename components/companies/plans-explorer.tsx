  ...
  return (
    <section id="plany" ref={sectionAnim.ref} className={`space-y-6 ${sectionAnim.className}`}>
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-4">
          <label className="flex items-center gap-2 text-xs uppercase text-muted-foreground">
            ...
            >
              <SelectTrigger className="w-[120px] rounded-full border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] px-3 py-1 text-xs font-semibold text-foreground shadow-sm">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="rounded-full border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-1 shadow-sm">
              <button
                type="button"
                className={cn(
      ...
      {plansWithComputed.length === 0 ? (
        <div className="rounded-2xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-8 text-center shadow-sm">
          <p className="text-sm text-muted-foreground">
...
function PlanCard({
  ...
  return (
    <article className="group flex flex-col gap-4 rounded-3xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-6 shadow-sm transition-all hover:border border-border/60-premium hover:shadow-sm-lg">
      ...
      <div className="grid gap-3 rounded-xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-4 shadow-sm sm:grid-cols-2">
        <PlanStat
          label="Max drawdown"
      ...
      {plan.features.length ? (
        <div className="space-y-2 rounded-xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-4 shadow-sm text-sm">
      ...
      <div className="space-y-2 rounded-xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-4 shadow-sm text-sm text-muted-foreground">
        {plan.accountType ? (
          <div className="flex items-center gap-2">
            <span>Typ konta:</span>
...
function PlanComparisonTable({
  ...
  if (plans.length < 2) {
    return (
      <div className="rounded-2xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-6 text-sm text-muted-foreground shadow-sm">
  ...
  return (
    <div className="overflow-x-auto rounded-2xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm">
