      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Select value={sort} onValueChange={(value) => setSort(value as SortOption)}>
              <SelectTrigger className="w-[180px] rounded-full border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <Tabs value={filter} onValueChange={(value) => setFilter(value as FilterId)}>
            <TabsList className="gap-1 rounded-full border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-1 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            >
              <Card
                ...
                className="group h-full rounded-2xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm transition-all hover:border-primary/50 hover:shadow-md"
              >
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {review.recommended !== null && (
                      <PremiumBadge
                        variant={review.recommended ? "gradient" : "outline"}
                        className={cn(
              ...
              <CardContent className="space-y-4 pt-0">
                ...
                {review.resourceLinks.length > 0 ? (
                  <div className="space-y-2 rounded-lg border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] p-3 shadow-sm">
