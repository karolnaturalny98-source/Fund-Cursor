  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {/* Allowed Rules */}
        <Card className={`rounded-xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm transition-all hover:border-primary/50 hover:shadow-md border-emerald-500/20 bg-emerald-500/10`}>
          <CardHeader 
        ...
        {/* Restricted Rules */}
        <Card className={`rounded-xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm transition-all hover:border-primary/50 hover:shadow-md border-rose-500/20 bg-rose-500/10`}>
          <CardHeader 
            className="cursor-pointer space-y-2 pb-3"
