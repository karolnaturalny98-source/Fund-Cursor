...
export function RankingsPageClient({
  ...
  return (
    <>
      ...
      <Card className="rounded-lg border border-border/40 bg-[rgba(12,14,18,0.6)] shadow-sm transition-all duration-300 hover:shadow-md">
            ...
            {topOverall.length > 0 ? (
              topOverall.map((company, index) => {
                ...
                return (
                  <Card
                    key={company.id}
                    className="group relative overflow-hidden rounded-lg border border-border/40 bg-[rgba(12,14,18,0.6)] shadow-sm transition-all duration-300 hover:border-primary/30 hover:shadow-md hover:scale-[1.02] hover:-translate-y-0.5"
                  >
...
function StatCard({
  ...
  return (
    <Card className={`group relative overflow-hidden rounded-lg border border-border/40 bg-[rgba(12,14,18,0.6)] !backdrop-blur-[36px] p-2.5 shadow-sm transition-all duration-300 hover:border-border/60 hover:bg-[rgba(11,13,16,0.66)] hover:scale-[1.02] hover:-translate-y-0.5 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
    ...
    <>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          <Card className="rounded-2xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm transition-all hover:border-primary/50">
          ...
          <Card className="rounded-2xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm transition-all hover:border-primary/50 sm:col-span-2 lg:col-span-1">
            <CardHeader className="space-y-2 pb-3">
              <CardTitle className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
                Wagi filarow
              </CardTitle>
      ...
      <div className="space-y-6">
        ...
        <Accordion type="single" collapsible className="grid gap-4 md:grid-cols-2">
          <AccordionItem value="faq-1" className="rounded-3xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] px-6 shadow-sm">
          ...
          <AccordionItem value="faq-2" className="rounded-3xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] px-6 shadow-sm">
            <AccordionTrigger className="text-base font-semibold text-foreground hover:no-underline">
          ...
          <AccordionItem value="faq-3" className="rounded-3xl border border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] px-6 shadow-sm md:col-span-2">
            <AccordionTrigger className="text-base font-semibold text-foreground hover:no-underline">
