    ...
    <div className="container space-y-8 py-8">
      ...
      <div className="space-y-6">
        ...
        <div className="mx-auto grid max-w-3xl grid-cols-3 gap-4">
          <div className="rounded-lg border border-border/40 bg-[rgba(12,14,18,0.6)] !backdrop-blur-[36px] p-4 shadow-sm transition-all hover:border-border/60 hover:bg-[rgba(11,13,16,0.66)]">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value={activeTab} className="mt-6">
          <Card className="border-border/60 !bg-[rgba(10,12,15,0.72)] !backdrop-blur-[36px] shadow-sm">
            <CardHeader>
